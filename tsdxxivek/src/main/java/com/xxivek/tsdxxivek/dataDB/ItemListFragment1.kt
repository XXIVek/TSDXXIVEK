...
import com.xxivek.tsdxxivek.databinding.FragmentItemList1Binding
 ...
 * Use the [ItemListFragment1.newInstance] factory method to
 * create an instance of this fragment.
 */
class ItemListFragment1 : Fragment() {
    // Интерфейс доступа к базе данных
    //private var itemDatabase: ItemDao?=null

    // binding FragmentItemListBinding
    private var _binding: FragmentItemList1Binding?=null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        _binding = FragmentItemList1Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.floatingActionButton.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_itemListFragment1_to_addItemFragment)
        )
...
//                    itemDatabase?.delete(removeItem)
            ...
            override fun onItemClick (position: Int) {
                ...
                binding.root.findNavController()
                    .navigate(R.id.action_itemListFragment1_to_addItemFragment,instBindle)
            }
        }
        )
    }
